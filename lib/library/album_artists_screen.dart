            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Artistas del álbum', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Artistas del álbum')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Artistas del álbum', icon: Icons.record_voice_over_rounded, iconBgColor: const Color(0xFF7C3AED),
