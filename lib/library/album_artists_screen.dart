...
class AlbumArtistsScreen extends StatefulWidget {
  const AlbumArtistsScreen({super.key});
  @override
  State<AlbumArtistsScreen> createState() => _AlbumArtistsScreenState();
}

class _AlbumArtistsScreenState extends State<AlbumArtistsScreen> {
            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF8B4FAE), shape: BoxShape.circle),
                  child: const Icon(Icons.person, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Artistas del álbum', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Artistas del álbum', icon: Icons.person),
