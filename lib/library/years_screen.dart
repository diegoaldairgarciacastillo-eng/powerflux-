            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Años', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Años')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Años', icon: Icons.calendar_month_rounded, iconBgColor: const Color(0xFF0891B2),
