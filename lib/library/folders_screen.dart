      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  ...
                  child: const Icon(Icons.folder, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Carpetas', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Carpetas', icon: Icons.folder,
            ...
            const Expanded(child: Center(child: Text('Sin carpetas', style: TextStyle(color: Color(0xFF555555))))),
            if (_selectionMode)
              SelectionBar(
