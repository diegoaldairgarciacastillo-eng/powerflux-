            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF8B7A2A), shape: BoxShape.circle),
                  child: const Icon(Icons.fast_forward, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Cola', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Cola', icon: Icons.fast_forward),
