            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF6A5ACD), shape: BoxShape.circle),
                  child: const Icon(Icons.album, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Álbumes', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Álbumes', icon: Icons.album),
