...
class LongTracksScreen extends StatefulWidget {
  const LongTracksScreen({super.key});
  @override
  State<LongTracksScreen> createState() => _LongTracksScreenState();
}

class _LongTracksScreenState extends State<LongTracksScreen> {
            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.more_time_rounded, color: Colors.white, size: 22),
                ),
                const SizedBox(width: 12),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Pistas largas', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Pistas largas')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Pistas largas', icon: Icons.more_time_rounded, iconBgColor: const Color(0xFF6D28D9),
