            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF8B3FAE), shape: BoxShape.circle),
                  child: const Icon(Icons.play_circle, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Lo más reproducido', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Lo más reproducido', icon: Icons.play_circle),
