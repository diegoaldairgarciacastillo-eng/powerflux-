          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                  width: 42, height: 42,
                  decoration: const BoxDecoration(color: Color(0xFF5B5BD6), shape: BoxShape.circle),
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Todas las canciones')))),
                const SizedBox(width: 8),
            ...
            if (songs.isEmpty)
              const Expanded(child: Center(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Icon(Icons.music_off_rounded, color: Color(0xFF333333), size: 64),
                  SizedBox(height: 12),
                  Text('No hay canciones', style: TextStyle(color: Color(0xFF555555), fontSize: 16)),
                  SizedBox(height: 4),
                  Text('Selecciona una carpeta con música',
