            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF8B4A3A), shape: BoxShape.circle),
                  child: const Icon(Icons.queue_music, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Listas de reproducción', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Listas de reproducción', icon: Icons.queue_music),
