            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  ...
                  child: const Icon(Icons.thumb_down, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Peor puntuado', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Peor puntuado', icon: Icons.thumb_down),
