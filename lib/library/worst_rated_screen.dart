...
class WorstRatedScreen extends StatefulWidget {
  const WorstRatedScreen({super.key});
  @override
  State<WorstRatedScreen> createState() => _WorstRatedScreenState();
}

class _WorstRatedScreenState extends State<WorstRatedScreen> {
            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.thumb_down_rounded, color: Colors.white, size: 22),
                ),
                const SizedBox(width: 12),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Peor puntuado', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Peor puntuado')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Peor puntuado', icon: Icons.thumb_down_rounded, iconBgColor: const Color(0xFF4B5563),
