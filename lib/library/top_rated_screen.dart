            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF6A6A6A), shape: BoxShape.circle),
                  child: const Icon(Icons.thumb_up, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Mejor puntuado', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Mejor puntuado', icon: Icons.thumb_up),
