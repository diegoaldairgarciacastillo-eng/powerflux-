            ...
            Padding(
              ...
              child: Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Compositores', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Compositores')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Compositores', icon: Icons.person_rounded, iconBgColor: const Color(0xFF059669),
