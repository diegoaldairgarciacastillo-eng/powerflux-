            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF5B4ACD), shape: BoxShape.circle),
                  child: const Icon(Icons.play_circle_outline, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Reproducido recientemente', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Reproducido recientemente', icon: Icons.play_circle_outline),
