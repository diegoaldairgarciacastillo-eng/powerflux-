            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF2A7A3A), shape: BoxShape.circle),
                  child: const Icon(Icons.add_circle_outline, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Agregado recientemente', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Agregado recientemente', icon: Icons.add_circle_outline),
