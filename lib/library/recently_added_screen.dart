            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.fiber_new_rounded, color: Colors.white, size: 22),
                ),
                const SizedBox(width: 12),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Agregado recientemente', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Agregado recientemente')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Agregado recientemente', icon: Icons.fiber_new_rounded, iconBgColor: const Color(0xFF16A34A),
