            ...
            Padding(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.folder_copy_rounded, color: Colors.white, size: 22),
                ),
                const SizedBox(width: 12),
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Estructura de carpetas', style: TextStyle(color: Colors.white,
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                _Chip(icon: Icons.search_rounded, onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const SearchScreen(initialFilter: 'Estructura de carpetas')))),
                const SizedBox(width: 8),
                ...
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context,
                      title: 'Estructura de carpetas', icon: Icons.folder_copy_rounded, iconBgColor: const Color(0xFF2563EB),
