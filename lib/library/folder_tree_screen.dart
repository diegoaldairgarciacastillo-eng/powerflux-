...
import 'shared/folder_picker_dialog.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                Container(width: 52, height: 52,
                  decoration: const BoxDecoration(color: Color(0xFF3A7BD5), shape: BoxShape.circle),
                  child: const Icon(Icons.account_tree, color: Colors.white, size: 26)),
                const SizedBox(width: 14),
                const Text('Estructura de carpetas', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
              ]),
            ),
            Padding(
              ...
              child: Row(children: [
                ...
                const Spacer(),
                GestureDetector(
                  onTap: () => LibraryOptionsMenu.show(context, title: 'Estructura de carpetas', icon: Icons.account_tree,
                    onSelectFolders: () => FolderPickerDialog.show(context)),
            ...
            Expanded(
              child: ListTile(
                ...
                leading: const Icon(Icons.graphic_eq, color: Color(0xFF555555), size: 40),
                title: const Text('Music', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                subtitle: const Text('RMX3890\n♪ 1156 | 107:31:52', style: TextStyle(color: Color(0xFF888888), fontSize: 12)),
                trailing: const Icon(Icons.folder_outlined, color: Color(0xFF666666)),
              ),
            ),
            if (_selectionMode)
              SelectionBar(
                selectedCount: _selected.length, totalCount: 1,
